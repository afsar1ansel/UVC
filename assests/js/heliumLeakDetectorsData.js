...
const heliumLeakDetectors = [
  {
    id: "HLD-PFEIFFER-ADIXEN",
    title: "PFEIFFER ADIXEN ASM",
    description: "High-performance helium leak detectors from Pfeiffer Adixen ASM series for precise leak detection.",
    code: "ASM SERIES",
  ...
  },
  {
    id: "HLD-ACCESSORIES",
    title: "Accessories",
    description: "Essential accessories for helium leak detectors including sniffer probes, hoses, and connectors.",
    code: "HLD ACCESSORIES",
    images: ["./assests/img/placeholder.png"],
    features: ["Wide compatibility", "Durable materials", "Optimized performance"]
  },
  {
