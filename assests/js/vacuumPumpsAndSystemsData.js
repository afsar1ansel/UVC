...
const vacuumPumpsAndSystems = [
  ...
  {
    id: "UVS-IVRRVP-M-SERIES",
    sequence: 7,
    code: "IVRRVP-M-SERIES",
    name: "IVRRVP-M Series Roots - Air Cooled Vacuum Pumps",
    title: "ROOTS - AIR COOLED VACUUM PUMPS",
    description:
      "The IVRRVP-M Series consists of air-cooled roots vacuum pumps designed for high-capacity industrial applications requiring efficient displacement and reliable ultimate vacuum performance. These pumps are robustly built for continuous operation in demanding environments.",
    features: [
